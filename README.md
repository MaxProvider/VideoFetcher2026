...
<p align="center">
  <a href="https://videofetcher.co.uk/downloads.html">⬇️ Download</a> ·
  <a href="https://videofetcher.co.uk/purchase.html">🔑 Purchase License</a> ·
  <a href="https://videofetcher.co.uk/howto.html">📖 Documentation</a> ·
...
|----------|----------|-------|
| 🐧 **Linux x86_64** | [Download](https://videofetcher.co.uk/files/VideoFetcher2026) | Requires yt-dlp and ffmpeg installed (`sudo apt install yt-dlp ffmpeg`) |
| 🪟 **Windows x64** | [Download](https://videofetcher.co.uk/files/VideoFetcher2026.exe) | yt-dlp and ffmpeg bundled — no extra installs needed |
...
👉 **[Purchase a lifetime licence](https://videofetcher.co.uk/purchase.html)** — one-time payment, no subscriptions, no recurring fees.
...
### MetaFetch (Free)
Scans your existing video library and fetches missing `.info.json` metadata files using yt-dlp.
👉 **[Download MetaFetch](https://videofetcher.co.uk/metafetch.html)**
...
All payments processed by [Stripe](https://stripe.com). We never see or store card details.
...
- ⬇️ **Downloads:** [videofetcher.co.uk/downloads.html](https://videofetcher.co.uk/downloads.html)
- 🔑 **Purchase:** [videofetcher.co.uk/purchase.html](https://videofetcher.co.uk/purchase.html)
- 📖 **Documentation:** [videofetcher.co.uk/howto.html](https://videofetcher.co.uk/howto.html)
